MongoExpressResource - Express library to reflect Mongoose models to a REST interface

# Introduction

MongoExpressResource is designed to be a minimalistic Express library that reflects a Mongoose
